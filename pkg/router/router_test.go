...
type pMock struct{ id types.PluginID; caps []types.Capability }
func (m *pMock) ID() types.PluginID { return m.id }
func (m *pMock) Describe(ctx context.Context) (providerregistry.Descriptor, error) {
	return providerregistry.Descriptor{ID: m.id, Capabilities: m.caps, Models: []providerregistry.ModelInfo{{ID: "m1", Capabilities: m.caps}}}, nil
}
...
func (m *pMock) Health(ctx context.Context) error { return nil }
...
func (m *rMock) Describe(ctx context.Context) (runtimeregistry.Descriptor, error) {
	return runtimeregistry.Descriptor{ID: m.id}, nil
}
...
func TestRoute(t *testing.T) {
	...
	_ = pr.Register(&pMock{id: "prov.a", caps: []types.Capability{"coding", "tools"}})
